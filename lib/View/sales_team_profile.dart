  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Sales Team Details", style: TextStyle(color: SysColor.tileColor),),
        leading: IconButton(onPressed: (){Get.to(()=>SalesTeam());}, icon: Icon(Icons.arrow_back_ios_new_rounded, color: SysColor.tileColor,)),
        actions: [
        ...
        child: ListView(
          children: [
            ...
            Row(
              ...
              children: [
              Text("New Prospects (${data['prospects']})", style: FontStyles.bodyStyle.copyWith(color: SysColor.tileColor, fontSize: 12, fontWeight: FontWeight.bold),),
              Obx(()=>TextButton(onPressed: (){controller.showDate(context);}, child: Text("${controller.day.value}, ${controller.month.value}")),),
            ],),
          ],
        ),
      ),
